...
SELECT 
    ...
    raw.employment_2024 AS employment, 
    raw.median_annual_wage_usd AS annual_wage,
    
    raw.ai_exposure_llm_human AS ai_exposure, 
    
    raw.ai_exposure_llm_human,
    raw.ai_exposure_aioe,
    raw.ai_exposure_level AS exposure_level,
    
    raw.verbal_ability,
    raw.quantitative_ability AS quant_ability,
    raw.spatial_ability,
